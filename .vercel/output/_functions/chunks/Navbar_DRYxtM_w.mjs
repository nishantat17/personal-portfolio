...
const $$Index$1 = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "vercel-speed-insights", "vercel-speed-insights", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/home/nishant/coding/personal-portfolio/node_modules/.pnpm/@vercel+speed-insights@2.0.0/node_modules/@vercel/speed-insights/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/nishant/coding/personal-portfolio/node_modules/.pnpm/@vercel+speed-insights@2.0.0/node_modules/@vercel/speed-insights/dist/astro/index.astro", void 0);
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const propsStr = JSON.stringify(Astro2.props);
  const paramsStr = JSON.stringify(Astro2.params);
  return renderTemplate`${renderComponent($$result, "vercel-analytics", "vercel-analytics", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/home/nishant/coding/personal-portfolio/node_modules/.pnpm/@vercel+analytics@2.0.1/node_modules/@vercel/analytics/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/nishant/coding/personal-portfolio/node_modules/.pnpm/@vercel+analytics@2.0.1/node_modules/@vercel/analytics/dist/astro/index.astro", void 0);

const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Layout;
  const { title } = Astro2.props;
  return renderTemplate`<html lang="en" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="icon" href="/favicon.ico"><link rel="stylesheet" href="https://cdn.hugeicons.com/font/hgi-stroke-rounded.css"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head> <body data-astro-cid-sckkx6r4> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "SpeedInsights", $$Index$1, { "data-astro-cid-sckkx6r4": true })} ${renderComponent($$result, "Analytics", $$Index, { "data-astro-cid-sckkx6r4": true })}</body></html>`;
}, "/home/nishant/coding/personal-portfolio/src/layouts/Layout.astro", void 0);

const Logo = new Proxy({"src":"/_astro/logo.DBHG204A.png","width":845,"height":461,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/nishant/coding/personal-portfolio/src/assets/logo.png";
							}
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<nav class="px-4 py-4 fixed top-0 w-full backdrop-blur-sm shadow-xs z-50"> ${renderComponent($$result, "Font", $$Font, { "cssVariable": "--jetbrains-mono", "preload": true })} ${renderComponent($$result, "Font", $$Font, { "cssVariable": "--bitcount", "preload": true })} <div class="flex items-center justify-between max-w-2xl mx-auto"> <a href="/#hero"> ${renderComponent($$result, "Image", $$Image, { "src": Logo, "alt": "Logo", "height": 18 })} </a> <ul class="flex items-center justify-center gap-2 *:ml-4 font-jetbrains-mono"> <li><a href="/projects">Projects</a></li> <li><a href="/journal">Journal</a></li> <li><a href="/#contact">Contact</a></li> </ul> </div> </nav>`;
}, "/home/nishant/coding/personal-portfolio/src/components/Navbar.astro", void 0);

export { $$Layout as $, $$Navbar as a, renderScript as b, getEntry as g, renderEntry as r };
